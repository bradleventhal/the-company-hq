  ...
  const sections = [
    ...
    },
    {
      ...
      content: [
        ...
        { label: 'Can I customize agent colors?', desc: 'Yes! Create openclawfice.config.json in your OpenClaw home dir.' },
      ...
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <p style={{ margin: '8px 0 0' }}>
            <a href="https://github.com/openclawfice/openclawfice/issues" target="_blank" rel="noopener noreferrer" style={{ color: '#8b5cf6', textDecoration: 'none' }}>
              Report a bug →
            </a>
          </p>
        </div>
