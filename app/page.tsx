    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* ACTIVITY LOG */}
          <Room title="Activity Log" icon="📡" color="#0a1a0a" borderColor="#166534" dataTour="activity-log">
            <div style={{
              padding: '6px 4px',
              maxHeight: 180,
              overflowY: 'auto',
              ...
              {/* Live agent status */}
              {agents.filter(a => a.status === 'working' && a.task).length > 0 && (
                <div style={{ marginBottom: 6 }}>
                  ...
                  {agents.filter(a => a.status === 'working' && a.task).map(a => (
                    <div
                      key={`live-${a.id}`}
                      style={{
                        display: 'flex',
                        ...
                        borderLeft: `2px solid ${a.color || '#4ade80'}`,
                        borderRadius: '0 4px 4px 0',
                      }}
                    >
                      <span style={{
                        fontWeight: 700,
                        color: a.color || '#4ade80',
                        whiteSpace: 'nowrap',
                        minWidth: 50,
                        fontSize: 8,
                      }}>
                      ...
                      <span style={{
                        ...
                        {(a.task || '').length > 80 ? (a.task || '').slice(0, 80) + '…' : a.task}
                      </span>
                    </div>
                  ))}
                </div>
              ...
              {/* Historical activity log entries */}
              {activityLog.length > 0 ? (
                <div>
                  ...
                  {activityLog.slice(0, 10).map((entry, i) => (
                    ...
                    >
                      ...
                      <span style={{
                        fontWeight: 700,
                        color: agents.find(a => a.name === entry.who)?.color || theme.textDim,
                        whiteSpace: 'nowrap',
                        minWidth: 50,
                        fontSize: 8,
                      }}>
                ...
                <div style={{
                  ...
                  No activity yet
                  <br />
                  <span style={{ fontSize: 7, fontStyle: 'italic' }}>
                    Agent work will appear here in real-time
                  </span>
                </div>
              ) : null}
            </div>
