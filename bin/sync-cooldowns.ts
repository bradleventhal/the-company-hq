...
/**
 * OpenClawfice Cooldown Sync — Auto-create/update cron jobs from config
 * 
 * Reads openclawfice.config.json and syncs cooldown timers to OpenClaw cron jobs.
 */
...
const JOB_NAME_PREFIX = 'openclawfice-cooldown-';
...
function readConfig(): { cooldown?: CooldownConfig; agents?: any } {
  ...
  console.log('⚠️  No openclawfice.config.json found. Exiting.');
  process.exit(0);
}
 ...
 */
function main() {
  console.log('🔄 OpenClawfice Cooldown Sync\n');
